...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-page-core002.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jsf-page-core004.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
validate a component's data. link:#BNATD[Table 11-5] lists all the
...
[width="53%",cols="51%,49%,",options="header",]
|=======================================================================
...
11-5]) inside the component's tag. link:#BNATF[Using Validator Tags]
