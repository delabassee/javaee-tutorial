...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-facelets002.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jsf-facelets004.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#GIQTE[Section 8.3.1, "Creating a Facelets Application"]
* link:#GJJKC[Section 8.3.2, "Configuring the Application"]
* link:#GIRGF[Section 8.3.3, "Running the guessnumber-jsf Facelets
Example"]
...
* link:#GJQZL[Section 8.3.3.1, "To Build, Package, and Deploy the
guessnumber-jsf Example Using NetBeans IDE"]
* link:#GJQYU[Section 8.3.3.2, "To Build, Package, and Deploy the
guessnumber-jsf Example Using Maven"]
* link:#GJQYX[Section 8.3.3.3, "To Run the guessnumber-jsf Example"]
...
8.3.3.2 To Build, Package, and Deploy the guessnumber-jsf Example Using
Maven
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
