...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-page-core001.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jsf-page-core003.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
link:#GKCLY[Table 11-4], one of which must be used.
