...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:security-webtier001.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:security-webtier003.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#CHDBIBHI[Section 48.2.1, "Overview of Securing Web
Applications"]
* link:#BNCBK[Section 48.2.2, "Specifying Security Constraints"]
* link:#GKBSA[Section 48.2.3, "Specifying Authentication Mechanisms"]
* link:#BNCBN[Section 48.2.4, "Specifying an Authentication Mechanism in
the Deployment Descriptor"]
* link:#BNCAV[Section 48.2.5, "Declaring Security Roles"]
...
link:security-advanced.html#GJJWX[Chapter 50, "Java EE Security: Advanced
Topics"].
...
link:#BNCBP[Figure 48-1] shows what happens when you specify HTTP basic
authentication.
...
image:img/javaeett_dt_045.png[Description of Figure 48-1 follows] +
link:img_text/javaeett_dt_045.html[Description of "Figure 48-1 HTTP Basic
Authentication"] +
 +
...
link:#GEXFA[Figure 48-2] shows what happens when you specify form-based
authentication.
...
image:img/javaeett_dt_046.png[Description of Figure 48-2 follows] +
link:img_text/javaeett_dt_046.html[Description of "Figure 48-2 Form-Based
Authentication"] +
 +
