...
image:img/javaeett_dt_060.png[Description of Figure 56-1 follows] +
link:img_text/javaeett_dt_060.html[Description of "Figure 56-1 Architecture
of the taskcreator Example"] +
 +
