...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-custom002.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jsf-custom004.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#GLPBD[Section 15.3.1, "Why Use JavaServer Faces Technology to
Implement an Image Map?"]
* link:#GLPEM[Section 15.3.2, "Understanding the Rendered HTML"]
* link:#GLPCD[Section 15.3.3, "Understanding the Facelets Page"]
* link:#GLPBO[Section 15.3.4, "Configuring Model Data"]
* link:#GLPEL[Section 15.3.5, "Summary of the Image Map Application
Classes"]
...
(see link:jsf-configure005.html#BNAWR[Section 16.5.1, "Using the
managed-bean Element"]). Here is part of the managed bean declaration
for the `ImageArea` bean corresponding to the South America hotspot:
