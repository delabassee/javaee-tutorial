...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:persistence-basicexamples001.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:persistence-basicexamples003.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
link:#CHDGGDIA[Figure 38-1].

[[CHDGGDIA]]

Figure 38-1 Database Schema for the order Application

image:img/javaeett_dt_024.png[Description of Figure 38-1 follows] +
link:img_text/javaeett_dt_024.html[Description of "Figure 38-1 Database
Schema for the order Application"] +
 +
...
* link:#GIQQR[Section 38.2.1.1, "Self-Referential Relationships"]
* link:#GIQSR[Section 38.2.1.2, "One-to-One Relationships"]
* link:#GIQTJ[Section 38.2.1.3, "One-to-Many Relationship Mapped to
Overlapping Primary and Foreign Keys"]
* link:#GIQUD[Section 38.2.1.4, "Unidirectional Relationships"]
...
38.2.1.3 One-to-Many Relationship Mapped to Overlapping Primary and
Foreign Keys
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* link:#GIQUV[Section 38.2.2.1, "Generated Primary Keys"]
* link:#GIQUF[Section 38.2.2.2, "Compound Primary Keys"]
...
* link:#GIQSG[Section 38.2.8.1, "To Run the order Example Using NetBeans
IDE"]
* link:#GIQTY[Section 38.2.8.2, "To Run the order Example Using Maven"]
