...
image:img/javaeett_dt_062.png[Description of Figure 59-1 follows] +
link:img_text/javaeett_dt_062.html[Description of "Figure 59-1 Architecture
of the Duke's Forest Example Application"] +
 +
...
image:img/javaeett_dt_063.png[Description of Figure 59-2 follows] +
link:img_text/javaeett_dt_063.html[Description of "Figure 59-2 Interactions
between Duke's Forest Components"] +
 +
...
image:img/javaeett_dt_064.png[Description of Figure 59-3 follows] +
link:img_text/javaeett_dt_064.html[Description of "Figure 59-3 Duke's Forest
