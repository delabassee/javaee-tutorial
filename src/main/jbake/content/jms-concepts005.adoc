...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jms-concepts004.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jms-concepts006.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#CHDGICJB[Section 45.5.1, "Overview of Using the JMS API"]
* link:#BABHFBDH[Section 45.5.2, "Creating Resources for Java EE
Applications"]
* link:#BNCGM[Section 45.5.3, "Using Resource Injection in Enterprise
Bean or Web Components"]
* link:#BNCGN[Section 45.5.4, "Using Java EE Components to Produce and
to Synchronously Receive Messages"]
* link:#BNCGQ[Section 45.5.5, "Using Message-Driven Beans to Receive
Messages Asynchronously"]
* link:#BNCGS[Section 45.5.6, "Managing JTA Transactions"]
...
* link:#CHDCHDIJ[Section 45.5.3.1, "Injecting a ConnectionFactory,
Queue, or Topic"]
* link:#BABCJBEE[Section 45.5.3.2, "Injecting a JMSContext Object"]
...
link:jms-examples.html#BNCGV[Chapter 46, "Java Message Service Examples"]
...
link:#GJKOH[Table 45-3] lists the activation configuration properties
...
[width="33%",cols="100%,",options="header",]
|=======================================================================
