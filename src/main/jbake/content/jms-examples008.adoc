...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jms-examples007.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jms-examples009.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
image:img/javaeett_dt_037.png[Description of Figure 46-4 follows] +
link:img_text/javaeett_dt_037.html[Description of "Figure 46-4 An Enterprise
Bean Application: Client to Session Bean to Message-Driven Bean"] +
 +
