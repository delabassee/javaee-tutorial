...
* link:#GLIEQ[Section 50.2.1, "Client Authentication"]
* link:#GLIEL[Section 50.2.2, "Mutual Authentication"]
...
* Certificate-based (see link:#GLIFJ[Figure 50-1])
* User name/password-based (see link:#GLIGQ[Figure 50-2])
...
link:#GLIFJ[Figure 50-1] shows what occurs during certificate-based
mutual authentication.
...
image:img/javaeett_dt_048.png[Description of Figure 50-1 follows] +
link:img_text/javaeett_dt_048.html[Description of "Figure 50-1
...
link:#GLIGQ[Figure 50-2] shows what occurs during user
...
image:img/javaeett_dt_049.png[Description of Figure 50-2 follows] +
link:img_text/javaeett_dt_049.html[Description of "Figure 50-2 User
Name/Password-Based Mutual Authentication"] +
 +
