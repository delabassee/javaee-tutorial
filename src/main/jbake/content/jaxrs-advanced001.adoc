...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jaxrs-advanced.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jaxrs-advanced002.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
JAX-RS provides the annotations listed in link:#GKOBO[Table 31-1].
