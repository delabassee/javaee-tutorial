...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:ejb-basicexamples004.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:ejb-basicexamples006.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
link:#GIQLY[Table 34-1] shows the calendar-based timer attributes.

[[sthref154]][[GIQLY]]

Table 34-1 Calendar-Based Timer Attributes

[width="51%",cols="30%,45%,25%,",options="header",]
|=======================================================================
...
* link:#GIQNI[Section 34.5.8.1, "To Run the timersession Example Using
NetBeans IDE"]
* link:#GIQNQ[Section 34.5.8.2, "To Build, Package, and Deploy the
timersession Example Using Maven"]
* link:#GIQOP[Section 34.5.8.3, "To Run the Web Client"]
...
tut-install`/examples/ejb/timersession/target/timersession.war`, deploys
...
34.5.8.2 To Build, Package, and Deploy the timersession Example Using
Maven
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
