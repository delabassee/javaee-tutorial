...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:persistence-criteria002.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:persistence-string-queries.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#GJIVS[Section 40.3.1, "Creating a Criteria Query"]
* link:#GJIVQ[Section 40.3.2, "Query Roots"]
* link:#GJIUV[Section 40.3.3, "Querying Relationships Using Joins"]
* link:#GJIVE[Section 40.3.4, "Path Navigation in Criteria Queries"]
* link:#GJIVI[Section 40.3.5, "Restricting Criteria Query Results"]
* link:#GJIXE[Section 40.3.6, "Managing Criteria Query Results"]
* link:#GJIVY[Section 40.3.7, "Executing Queries"]
...
`HAVING` clause. link:#GJIWW[Table 40-1] shows conditional methods you
...
time, and case operators and functions of JPQL. link:#GJIXL[Table 40-2]
...
* link:#GJIWO[Section 40.3.6.1, "Ordering Results"]
* link:#GJIXG[Section 40.3.6.2, "Grouping Results"]
