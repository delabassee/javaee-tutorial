...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:jsf-custom001.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:jsf-custom003.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
* link:#BNAVI[Section 15.2.1, "When to Use a Custom Component"]
* link:#BNAVJ[Section 15.2.2, "When to Use a Custom Renderer"]
* link:#BNAVK[Section 15.2.3, "Component, Renderer, and Tag
Combinations"]
...
[width="60%",cols="34%,,66%",options="header",]
|=======================================================================
