...
[cols="^5%,^5%,90%",]
|=======================================================================
|link:persistence-basicexamples002.html[image:img/leftnav.gif[Previous] +
Previous] 
|link:persistence-basicexamples004.html[image:img/rightnav.gif[Next] +
Next] | 
|=======================================================================
...
is shown in link:#CHDCHJHG[Figure 38-2].

[[CHDCHJHG]]

Figure 38-2 Database Schema for the roster Application

image:img/javaeett_dt_025.png[Description of Figure 38-2 follows] +
link:img_text/javaeett_dt_025.html[Description of "Figure 38-2 Database
Schema for the roster Application"] +
 +
...
* link:#GJJEX[Section 38.3.3.1, "Metamodel Classes in the roster
Application"]
* link:#GJJFN[Section 38.3.3.2, "Obtaining a CriteriaBuilder Instance in
RequestBean"]
* link:#GJJFF[Section 38.3.3.3, "Creating Criteria Queries in
...
* link:#GIQUG[Section 38.3.5.1, "To Run the roster Example Using
NetBeans IDE"]
* link:#GIQSJ[Section 38.3.5.2, "To Run the roster Example Using Maven"]
